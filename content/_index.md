...
Maka Ska, [backpack][] on the North Shore with my girlfriend, golf the cities
with the fellas, and [hunt][] for good surf with my brother (when finances
allow).

<!-- markdownlint-disable MD033 MD013 -->

{{< img src="image/on-the-lake.jpg" alt="Base Photo" priority="high" style="display:block;margin-left:auto;margin-right:auto;width:80%;height:80%;border-radius: 0.5rem;" >}}
