...
Conceptually, I understand each from a high level, but my goal it to get from
theoretical and conceptual knowledge to more practical and hands-on knowledge as
this is the true path to learning.

So, today I am starting off with understanding modern LLMs.
...
Although the architecture of these algorithms is similar, I believe the actual
function of the code is what separates LLMs from general machine learning. It
would make sense that machine learning is the mechanism used to *train* and
algorithm, but the LLM itself is just a probabilistic language program and is
trained to guess the correct next word purely based on probability. Which, when
you think about it, may just be how we are able to form language ourselves.

Anyways, let's put my current understanding to the test and walk through
[Transformers Explained][] and [Understanding the Modern LLM][].
...
relationship and pattern discovery. Basically, unsupervised learning.

Naturally, this leads us to AI:
